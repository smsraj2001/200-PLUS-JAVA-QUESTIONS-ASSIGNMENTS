    ...
    public int evaluate(String expression)
    {
        ...
        for(int i=0; i<expression.length();i++) 
        {
            ...
            else if(isOperator(c))
            {
                ...
                of the stack,the current operator can be placed in stack
                 2. else keep popping operator from stack and perform the operation in  
                 numbers stack till either stack is not empty or current operator has 
                 higher precedence than operator on top of the stack*/
