/**Didital World announces seasonal discount on the laptops in the given order.
...
payable by the customer on purchase.*/
...
System.out.println("\t\t\tTHE DIGITAL WORLD");
System.out.println("Enter the name of the customer:-");
String name=sc.next();
System.out.println("Enter the address of the customer:-");
String address=sc.next();
System.out.println("Enter the purchased amount of the customer:-");
int A=sc.nextInt();
